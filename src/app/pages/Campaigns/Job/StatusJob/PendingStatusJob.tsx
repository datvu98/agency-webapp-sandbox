    ...
    return (
        <Flex vertical gap={16}>
            ...
            <Row gutter={[16, 16]}>
                <Col span={18} >
                    <Flex vertical gap={16}>
                        <ProcessStatus status={jobDetailData?.status} loading={jobDetailLoading} hasDemoApproval={jobDetailData?.hasDemoApproval} />
                        <ProductInfo
...
export default PendingStatusJob