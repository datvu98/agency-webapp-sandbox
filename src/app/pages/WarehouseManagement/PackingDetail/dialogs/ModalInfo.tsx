        ...
        <Modal open={show} centered footer={null} onCancel={onHide} destroyOnClose>
            <div style={{ textAlign: "center", padding: "12px 8px" }}>
                <Flex vertical>
                    ...
                    <Text strong style={{color: '#d48e5b', fontSize: 16}}>{dataInfo?.warehouseBill?.trackingNumber || '--'}</Text>
                    <Text>Hàng hoá trong đơn:</Text>
                    <Text strong style={{color: '#d48e5b', fontSize: 16}}>{dataInfo?.variant?.variant_full_name || '--'}</Text>
                </Flex>
                <Flex justify="center">
