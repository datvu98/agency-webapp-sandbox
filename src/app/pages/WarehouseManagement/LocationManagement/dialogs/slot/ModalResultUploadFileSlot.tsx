...
const ModalResultsUploadSlot = ({ dataResults, onHide }) => {
	...
	return (
		<Modal open={!!dataResults} onCancel={onHide} centered title={"Kết quả tải file"} width={700} footer={null}>
			<Space direction="vertical" size="middle" style={{ width: "100%", marginBottom: 16 }}>
				<Text>
					Tổng số vị trí cần thêm vào khu vực : <Text strong>{dataResults?.meta?.total}</Text>
				</Text>

				<Text>
					Tổng số vị trí thêm thành công :{" "}
...
export default memo(ModalResultsUploadSlot);
