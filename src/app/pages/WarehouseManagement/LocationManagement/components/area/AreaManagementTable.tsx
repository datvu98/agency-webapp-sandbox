...
const AreaManagementTable = ({ locationManagerUpdate, setShowDetail, data, loading, error, refetch }) => {
						...
						switch (key) {
							...
							case "inactive":
								...
								if (dataInactive?.locationManagerUpdate?.success) {
									showAlert.success("Dừng hoạt động khu vực thành công.");
								} else {
									showAlert.error(dataInactive?.locationManagerUpdate?.message || "Dừng hoạt động khu vực thất bại.");
								}
								break;
							...
							case "active":
								...
								if (dataActive?.locationManagerUpdate?.success) {
									showAlert.success("Bật hoạt động khu vực thành công.");
								} else {
									showAlert.error(dataActive?.locationManagerUpdate?.message || "Bật hoạt động khu vực thất bại.");
								}
								break;
							default:
								break;
