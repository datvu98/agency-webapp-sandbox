...
const AisleManagementTable = ({ locationManagerUpdate, setShowDetail, data, loading, error, refetch }) => {
						...
						switch (key) {
							...
							case "inactive":
								...
								if (dataInactive?.locationManagerUpdate?.success) {
									showAlert.success("Dừng hoạt động luống đi thành công.");
								} else {
									showAlert.error(dataInactive?.locationManagerUpdate?.message || "Dừng hoạt động luống đi thất bại.");
								}
								break;
							...
							case "active":
								...
								if (dataActive?.locationManagerUpdate?.success) {
									showAlert.success("Bật hoạt động luống đi thành công.");
								} else {
									showAlert.error(dataActive?.locationManagerUpdate?.message || "Bật hoạt động luống đi thất bại.");
								}
								break;
							default:
								break;
...
export default AisleManagementTable;
