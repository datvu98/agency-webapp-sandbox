...
import { OPTION_ABNORMAL_TIME, OPTION_SHIPPING_CARRIERS } from "../constant";

const { Text } = Typography;
const { RangePicker } = DatePicker;

const AbnormalFilter = ({optionsWarehouse}) => {
                    ...
                    <Row align={"middle"}>
                        <Col span={8}>
                            <Select
                                ...
                                options={OPTION_ABNORMAL_TIME}
                                value={params?.date_search_type || OPTION_ABNORMAL_TIME[0]?.value}
                            />
                        </Col>
                        <Col span={16}>
                            <RangePicker
...
export default memo(AbnormalFilter);
