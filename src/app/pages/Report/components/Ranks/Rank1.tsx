    ...
    return (
        ...
        >
            ...
            <g filter="url(#rank-1-d)">
                <path
                    fill="#874D00"
                    d="M19.914 0V19.053h-.068l-3.526 2.363V18.35l3.584-2.442h3.575V30h-3.565Zm8.018.186a1.82 1.82 0 0 1-1.826-1.836c0-1.016.81-1.827 1.826-1.827a1.82 1.82 0 0 1 1.836 1.827c0 1.025-.811 1.835-1.836 1.835Z"
                />
            </g>
            <defs>
                <radialGradient
