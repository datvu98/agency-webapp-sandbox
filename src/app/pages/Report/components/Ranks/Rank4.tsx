...
export const Rank4Icon = (props: SVGProps<SVGSVGElement>) => {
    return (
        ...
        >
            ...
            <path
                fill="#F0F5FF"
                d="M21.648 29v01-2.93h-7.08V24.48l6.182-9.57h2.598v9.618h1.992v1.543h-1.992V29h-1.7Zm-5.341-4.473h5.341v-8.115h-.058l-5.283 8.076v.04Zm11.738 4.61a1.1 1.1 0 0 1-1.113-1.114 1.1 1.1 0 0 1 1.113-1.113 1.1 1.1 0 0 1 1.113 1.113 1.1 1.1 0 0 1-1.113 1.114Z"
            />
        </svg>
    );
};
