...
export default gql`
  query sme_catalog_inventory_items($order_by: [sme_catalog_inventory_items_order_by!] = {updated_at: desc,variant_id: desc}, $checklistid: Int, $billid: Int, $limit: Int, $offset: Int = 0,$where: sme_catalog_inventory_items_bool_exp ={} ) {
  sme_catalog_inventory_items(limit: $limit, offset: $offset, where: $where, order_by: $order_by) {
    ...
    in_warehouse_bill(args: {billid: $billid})
    sme_store_id
    stock_actual    
    sme_store_id
    stock_allocated    
